...
<section>
        ...
        <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="margin-left:950px;margin-top: 56px;">
            Add Ticket
          </button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form class="form-group" action='ticket_process.php' method='POST' id='frm_ticket'>
                      ...
                      <label>Email:</label><input type='text' placeholder="Email" class='form-control email' name='email'>
                      ...
                      <label>Issue Title:</label><input type='text' placeholder="issue title" class='form-control' name='issue_title' reqired>
                      <label>Issue Description:</label><textarea  placeholder="issue description" class='form-control' rows='3' name='issue_desc' required="true"></textarea>
...
//echo '   <span>sender:'. $row["id"].'</span>&nbsp &nbsp';
