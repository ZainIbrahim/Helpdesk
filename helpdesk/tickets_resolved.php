...
echo'  </li>';
echo' <li class="nav-item">';
echo'  <a class="nav-link active" href="tickets_resolved.php">Resolved <span class="badge badge-primary">'.$res_array.'</span></a>';
...
$sql = "SELECT * FROM ticket where status ='resolved'ORDER BY date_and_time DESC";
...
$result = $conn->query($sql);
   ...
   // if (){
      while($row = $result->fetch_assoc()) {
        ...
        echo '<a href="tickets_reply.php?id='.$row["id"].'"><h5>'. $row["issue_title"].'</h5></a>';
