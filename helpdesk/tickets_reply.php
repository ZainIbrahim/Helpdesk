...
require 'conn.php';
 ...
 echo'          <div class="dropdown "style="margin-left:600px">';
 echo'   <a class="btn btn-secondary dropdown-toggle col-sd-2" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
 echo'     status';
 echo'   </a>';

 echo'   <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">';
 echo'     <a class="dropdown-item" href="status_change.php?id='.$_GET["id"].'">Resolved</a>';
 echo'     <a class="dropdown-item" href="#">unresolved</a>';
 echo'   </div>';
 echo'  </div>';
 echo'  </div>';
...
$result = $conn->query($sql);
    ...
    $sql = "SELECT * FROM reply where reply_id=".$_GET['id'] ;
$result = $conn->query($sql);
    // output data of each row
      ...
      echo ' <h5>Replies</h5>';
      while ($row = $result->fetch_assoc()){
     echo"<p>". $row['reply_body']."&nbsp&nbsp&nbsp&nbsp" .$row['date_and_time']."</p>";
