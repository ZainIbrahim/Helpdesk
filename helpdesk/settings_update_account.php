...
$result = $conn->query($sql);
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo"   <label>Full Name</label><textarea type='text' class='form-control' rows='1' name='fullName'>".$row["name"]."</textarea>";
      echo"   <label>Username </label><textarea type='text' class='form-control'rows='1' name='username'>".$row["username"]."</textarea>";
      echo"  <label>Password </label><textarea type='password' class='form-control' rows='1' name='password'>".$row["password"]."</textarea>";
      echo"  <button type='submit' class='   btn btn-secondary mb-2' style='margin-top:10px'>Cancel</button>&nbsp";
      echo" <button type='submit' class='btn btn-primary mb-2' style='margin-top:10px'>Update</button>";
