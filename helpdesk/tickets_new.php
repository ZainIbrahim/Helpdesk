...
$array= mysqli_num_rows($result);
    ...
    echo'<a class="nav-link active" href="tickets_new.php">New <span class="badge badge-primary">'.$array.'</span></a>';
...
$sql = "SELECT * FROM ticket where date_and_time =.date().";
$sql = "SELECT * FROM ticket WHERE date_and_time > DATE_SUB(NOW(), INTERVAL 1 DAY) ORDER BY date_and_time DESC";        
